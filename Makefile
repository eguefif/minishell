...
_SRC_LIB_STATIC = parser.c executer.c cleaner.c lexer.c lexer_get_tokens.c error.c parser_get_commands.c parser_clean_commands.c lexer_count_tokens.c lexer_get_token_size.c parser_get_commands_populate.c

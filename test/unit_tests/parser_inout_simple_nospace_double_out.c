...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   parser_redir_outin_nospace_doubleout.c             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: eguefif <eguefif@student.42quebec.>        +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/11/17 09:47:23 by eguefif           #+#    #+#             */
/*   Updated: 2023/11/17 09:57:11 by eguefif          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main()
{
	t_command *test;
	int i = 0;
	char *tab = "cat requirements.txt < file1 >test2 > test";

	char	*args1[] = {"cat", "requirements.txt", 0};
	t_command cmd1 = {  .args = args1, 
						.redirections = { .r_stdin = "file1", .r_stdout = "test"}};

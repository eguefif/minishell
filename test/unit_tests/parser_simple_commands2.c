...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   parser_simple_commands2.c                          :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: maxpelle <maxpelle@student.42quebec>       +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/11/17 11:24:05 by maxpelle          #+#    #+#             */
/*   Updated: 2023/11/17 11:27:40 by maxpelle         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main()
{
	t_command *test;
	int i = 0;
	char *tab = "/bin/echo -n salut";

	char	*args1[] = {"/bin/echo", "-n", "salut", 0};

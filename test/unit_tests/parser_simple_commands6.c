...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   parser_simple_commands6.c                          :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: maxpelle <maxpelle@student.42quebec>       +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/11/17 11:35:42 by maxpelle          #+#    #+#             */
/*   Updated: 2023/11/17 11:37:32 by maxpelle         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv, char **env)
{
	...
	t_command *test;
	int i = 0;
	char *tab = "cat -e -n requirements.txt";

	char	*args1[] = {"cat", "-e", "-n", "requirements.txt", 0};

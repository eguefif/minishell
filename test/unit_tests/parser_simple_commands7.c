...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   parser_simple_commands7.c                          :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: maxpelle <maxpelle@student.42quebec>       +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/11/17 11:38:26 by maxpelle          #+#    #+#             */
/*   Updated: 2023/11/17 11:40:00 by maxpelle         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv, char **env)
{
	...
	t_command *test;
	int i = 0;
	char *tab = "/bin/echo -nnnnnn salut toi";

	char	*args1[] = {"/bin/echo", "-nnnnnn", "salut", "toi", 0};

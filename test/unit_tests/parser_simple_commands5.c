...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   parser_simple_commands5.c                          :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: maxpelle <maxpelle@student.42quebec>       +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/11/17 11:33:56 by maxpelle          #+#    #+#             */
/*   Updated: 2023/11/17 11:35:09 by maxpelle         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main()
{
	t_command *test;
	int i = 0;
	char *tab = "/bin/cat -en requirements.txt";

	char	*args1[] = {"/bin/cat", "-en", "requirements.txt", 0};
